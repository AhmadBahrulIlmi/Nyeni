    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={styles.container}>
        <View>
          <Image
            source={{
              uri: 'https://i.pinimg.com/564x/56/f9/f5/56f9f527d279696f41f74846f1ee9508.jpg',
            }}
            style={styles.logoImage}
          />
          <Text style={styles.header}>Selamat Datang</Text>
          <Text style={styles.caption}>
            Buat pengetahuan anda lebih luas dengan kesenian yang ada pada
            profinsi Jawa Timur
          </Text>
        ...
        <View style={{gap: 10}}>
          ...
          <View style={{flexDirection: 'row', gap: 5, alignSelf: 'center'}}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Register')}>
              <Text style={[button.label, {color: 'rgb(255, 161, 0)'}]}>
                Sign up
              </Text>
            </TouchableOpacity>
          </View>
